...
class Home extends Component {
    ...
    componentDidMount() {
        ...
        if (this.state.isLogin) {
            let userUrl = this.props.baseUrl + this.state.user_id + "?fields=media_count,username&access_token=" + this.state.access_token
            fetch(userUrl,{
                method:'GET',
              }).then((response) =>{
        ...
        if (this.state.isLogin) {
            let url = this.props.baseUrl + "me/media?fields=caption,media_url,thumbnail_url,timestamp&access_token=" + this.state.access_token
            fetch(url,{
                method:'GET',
              }).then((response) =>{
                  return response.json();
    ...
    captionSearchHandler = (keyword)=>{
        if(!(keyword==='')){
            ...
            this.state.searchOn?originalimageData = this.state.originalimageData:originalimageData=this.state.images
